                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleFullName1" aria-describedby="emailHelp" required="required">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="exampleInputPhno1" aria-describedby="emailHelp" required="required">
                        </div>
